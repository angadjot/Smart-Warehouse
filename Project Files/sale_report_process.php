    		...
    		<div class="page-break">
        		...
        		<tbody>
          			<?php foreach($results as $result): ?>
           				<tr>
              				<td class=""><?php echo remove_junk($result['ordDate']);?></td>
              				<td class="desc">
                				<h6><?php echo remove_junk(ucfirst($result['Pname']));?></h6>
              				</td>
              				<td class="text-right">₹<?php echo remove_junk($result['uPrice']);?></td>
              				<td class="text-right">₹<?php echo remove_junk($result['USP']);?></td>
